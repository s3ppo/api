...
## [4.1.2](https://github.com/s3ppo/api/compare/v4.13.1...v4.1.2) (2025-08-19)


### Features

* `createDockerFolder` & `setDockerFolderChildren` mutations ([#1558](https://github.com/s3ppo/api/issues/1558)) ([557b03f](https://github.com/s3ppo/api/commit/557b03f8829d3f179b5e26162fa250121cb33420))
* `deleteDockerEntries` mutation ([#1564](https://github.com/s3ppo/api/issues/1564)) ([78997a0](https://github.com/s3ppo/api/commit/78997a02c6d96ec0ed75352dfc9849524147428c))
* add `moveDockerEntriesToFolder` mutation ([#1569](https://github.com/s3ppo/api/issues/1569)) ([20c2d5b](https://github.com/s3ppo/api/commit/20c2d5b4457ad50d1e287fb3141aa98e8e7de665))
* add basic docker network listing ([#1317](https://github.com/s3ppo/api/issues/1317)) ([c4fdff8](https://github.com/s3ppo/api/commit/c4fdff8149eb2812707605b3a98eabc795d18c5e))
* add category.json ([e784391](https://github.com/s3ppo/api/commit/e784391ac3e400271d30220bb58b0a69494707d5))
* add developer docs ([#1128](https://github.com/s3ppo/api/issues/1128)) ([75474bd](https://github.com/s3ppo/api/commit/75474bde47ea15abd008b5cc930ce399f9668f62))
* add docker -&gt; organizer query ([#1555](https://github.com/s3ppo/api/issues/1555)) ([dfe352d](https://github.com/s3ppo/api/commit/dfe352dfa1bd6aa059cab56357ba6bff5e8ed7cb))
* add graphql resource for API plugins ([#1420](https://github.com/s3ppo/api/issues/1420)) ([642a220](https://github.com/s3ppo/api/commit/642a220c3a796829505d8449dc774968c9d5c222))
* add gui settings field for sso users ([#1310](https://github.com/s3ppo/api/issues/1310)) ([5ba3fa6](https://github.com/s3ppo/api/commit/5ba3fa67a26828f29e1e234c6838e7beaa3fdff3))
* add management page for API keys ([#1408](https://github.com/s3ppo/api/issues/1408)) ([0788756](https://github.com/s3ppo/api/commit/0788756b918a8e99be51f34bf6f96bbe5b67395a))
* add permission documentation by using a custom decorator ([#1355](https://github.com/s3ppo/api/issues/1355)) ([45ecab6](https://github.com/s3ppo/api/commit/45ecab6914e2e4dd48438352eb9a5084a6a4b996))
* add rclone ([#1362](https://github.com/s3ppo/api/issues/1362)) ([5517e75](https://github.com/s3ppo/api/commit/5517e7506b05c7bef5012bb9f8d2103e91061997))
* add ReplaceKey functionality to plugin ([#1264](https://github.com/s3ppo/api/issues/1264)) ([7e6be67](https://github.com/s3ppo/api/commit/7e6be67f616103997de673f0e275eb39d81d38f4))
* add resolver for logging ([#1222](https://github.com/s3ppo/api/issues/1222)) ([3f590c5](https://github.com/s3ppo/api/commit/3f590c56e389d863f9ff10ad175b6957f7dfaa56))
* add unraid-ui documentation ([#1142](https://github.com/s3ppo/api/issues/1142)) ([6378047](https://github.com/s3ppo/api/commit/6378047bc4e12642ec7188f7387562f82731d05e))
* add ups monitoring to graphql api ([#1526](https://github.com/s3ppo/api/issues/1526)) ([6ea94f0](https://github.com/s3ppo/api/commit/6ea94f061d5b2e6c6fbfa6949006960501e3f4e7))
* add webgui theme switcher component ([#1304](https://github.com/s3ppo/api/issues/1304)) ([e2d00dc](https://github.com/s3ppo/api/commit/e2d00dc3464f9663062ac759a8aad85e61804b91))
* allow deletion and creation of files with patches ([1392bde](https://github.com/s3ppo/api/commit/1392bdeecb7d0cf8572253e76b4dc9b0dbbfa90c))
* API key management ([#1407](https://github.com/s3ppo/api/issues/1407)) ([d37dc3b](https://github.com/s3ppo/api/commit/d37dc3bce28bad1c893ae7eff96ca5ffd9177648))
* api plugin management via CLI ([#1416](https://github.com/s3ppo/api/issues/1416)) ([3dcbfbe](https://github.com/s3ppo/api/commit/3dcbfbe48973b8047f0c6c560068808d86ac6970))
* api plugin system & offline versioned dependency vendoring ([#1252](https://github.com/s3ppo/api/issues/1252)) ([9f492bf](https://github.com/s3ppo/api/commit/9f492bf2175b1b909d3bec079ce901ba34765eb7))
* **api:** add `unraid-api --delete` command ([#1289](https://github.com/s3ppo/api/issues/1289)) ([2f09445](https://github.com/s3ppo/api/commit/2f09445f2ed6b23cd851ca64ac5b84cfde3cbd50))
* async disk mapping ([f22b262](https://github.com/s3ppo/api/commit/f22b262830418dbe1ad7003349ded8b2ef0952c1))
* attempt to resolve performance issues with rm earlier in build … ([#1152](https://github.com/s3ppo/api/issues/1152)) ([c74bdd8](https://github.com/s3ppo/api/commit/c74bdd8890a05e155d170d79d09f3b13b5e63a58))
* auto-docusaurus-prs ([#1127](https://github.com/s3ppo/api/issues/1127)) ([8a57576](https://github.com/s3ppo/api/commit/8a575765a946b9198109b549da6850545ef0a793))
* basic array controls ([#1291](https://github.com/s3ppo/api/issues/1291)) ([61fe696](https://github.com/s3ppo/api/commit/61fe6966caf973eec3d74c67741302dd4b507134))
* basic docker controls ([#1292](https://github.com/s3ppo/api/issues/1292)) ([12eddf8](https://github.com/s3ppo/api/commit/12eddf894e1808b61f5d4e007f3a7a39a3f2e4d6))
* basic vm controls ([#1293](https://github.com/s3ppo/api/issues/1293)) ([bc3ca92](https://github.com/s3ppo/api/commit/bc3ca92fb02387bc019bb001809df96974737b50))
* begin building plugin with node instead of bash ([#1120](https://github.com/s3ppo/api/issues/1120)) ([4f5c367](https://github.com/s3ppo/api/commit/4f5c367fdf094164a7b3022cdf9f9c1987b76485))
* bug report template ([d6fde34](https://github.com/s3ppo/api/commit/d6fde343653aec768d5e3e9a0d849afc3f1c41c2))
* build out docker components  ([#1427](https://github.com/s3ppo/api/issues/1427)) ([711cc9a](https://github.com/s3ppo/api/commit/711cc9ac926958bcf2996455b023ad265b041530))
* checkout correct branch on close ([#1123](https://github.com/s3ppo/api/issues/1123)) ([e7b7caa](https://github.com/s3ppo/api/commit/e7b7caae43b2ec48781d5d49262c7c39f8ccebe2))
* code first graphql ([#1347](https://github.com/s3ppo/api/issues/1347)) ([f5724ab](https://github.com/s3ppo/api/commit/f5724abffbcb8c8a4885c487df4119787fd1d541))
* connect settings page updated for responsive webgui ([#1585](https://github.com/s3ppo/api/issues/1585)) ([96c120f](https://github.com/s3ppo/api/commit/96c120f9b24d3c91df5e9401917c8994eef36c46))
* connect settings web component ([#1211](https://github.com/s3ppo/api/issues/1211)) ([acbf46d](https://github.com/s3ppo/api/commit/acbf46df3f00e7ffe7983ea0673cf2a15dff8176))
* contributing guide ([cc18239](https://github.com/s3ppo/api/commit/cc18239748ed681259e312cc7fefa790d7aff6b0))
* convert to pnpm monorepo ([#1137](https://github.com/s3ppo/api/issues/1137)) ([ad6b658](https://github.com/s3ppo/api/commit/ad6b6589dbe0465968205449643c81c1c9d4e613))
* copy to webgui repo script docs + wc build options ([#1285](https://github.com/s3ppo/api/issues/1285)) ([e54f189](https://github.com/s3ppo/api/commit/e54f189630f70aeff5af6bdef4271f0a01fedb74))
* docker and info resolver issues ([#1423](https://github.com/s3ppo/api/issues/1423)) ([9901039](https://github.com/s3ppo/api/commit/9901039a3863de06b520e23cb2573b610716c673))
* downgrade page replace key check ([#1263](https://github.com/s3ppo/api/issues/1263)) ([6a92f61](https://github.com/s3ppo/api/commit/6a92f61f1a39e0f57d814c90367ffc58d816a4af))
* feature request template ([0c0a63b](https://github.com/s3ppo/api/commit/0c0a63b525e31d137f7c2dab9e8b59e7adf6a7ae))
* fix docusaurus build + update snapshot ([7a19c93](https://github.com/s3ppo/api/commit/7a19c9331f24a0b9e4127f35f664a42f6b66e6c7))
* fix shading in UPC to be less severe ([#1438](https://github.com/s3ppo/api/issues/1438)) ([b7c2407](https://github.com/s3ppo/api/commit/b7c240784052276fc60e064bd7d64dd6e801ae90))
* group renovate updates ([d7b138b](https://github.com/s3ppo/api/commit/d7b138b2a72dbbfdf419b9ec1dbe430844f13a2d))
* ignore nuxt-custom-elements and reflect-metadata ([8590a49](https://github.com/s3ppo/api/commit/8590a494025ac8162869fb5e816d694982236970))
* implement OIDC provider management in GraphQL API ([#1563](https://github.com/s3ppo/api/issues/1563)) ([979a267](https://github.com/s3ppo/api/commit/979a267bc5e128a8b789f0123e23c61860ebb11b))
* improve local dev with install path ([#1221](https://github.com/s3ppo/api/issues/1221)) ([ce61fee](https://github.com/s3ppo/api/commit/ce61fee41ce41b1e33cdb7d1774157f1cb02b558))
* info resolver cleanup ([#1425](https://github.com/s3ppo/api/issues/1425)) ([1b279bb](https://github.com/s3ppo/api/commit/1b279bbab3a51e7d032e7e3c9898feac8bfdbafa))
* initial codeql setup ([#1390](https://github.com/s3ppo/api/issues/1390)) ([2ade7eb](https://github.com/s3ppo/api/commit/2ade7eb52792ef481aaf711dc07029629ea107d9))
* initialize claude code in codebse ([#1418](https://github.com/s3ppo/api/issues/1418)) ([b6c4ee6](https://github.com/s3ppo/api/commit/b6c4ee6eb4b9ebb6d6e59a341e1f51b253578752))
* major release-please workflow improvements ([#1160](https://github.com/s3ppo/api/issues/1160)) ([013cc1d](https://github.com/s3ppo/api/commit/013cc1de7d6762e24f979aaa9894fd524cbdb0ec))
* make log viewer component dynamic ([#1242](https://github.com/s3ppo/api/issues/1242)) ([a356bf0](https://github.com/s3ppo/api/commit/a356bf03fb7022933138e52dca377a4681691560))
* move activation code logic into the API ([#1369](https://github.com/s3ppo/api/issues/1369)) ([39e83b2](https://github.com/s3ppo/api/commit/39e83b2aa156586ab4da362137194280fccefe7c))
* move api key fetching to use api key service ([#1439](https://github.com/s3ppo/api/issues/1439)) ([86bea56](https://github.com/s3ppo/api/commit/86bea5627270a2a18c5b7db36dd59061ab61e753))
* move to cron v4 ([#1428](https://github.com/s3ppo/api/issues/1428)) ([b8035c2](https://github.com/s3ppo/api/commit/b8035c207a6e387c7af3346593a872664f6c867b))
* move to iframe for changelog ([#1388](https://github.com/s3ppo/api/issues/1388)) ([fcd6fbc](https://github.com/s3ppo/api/commit/fcd6fbcdd48e7f224b3bd8799a668d9e01967f0c))
* native slackware package ([#1381](https://github.com/s3ppo/api/issues/1381)) ([4f63b4c](https://github.com/s3ppo/api/commit/4f63b4cf3bb9391785f07a38defe54ec39071caa))
* public index ([8cbb3c4](https://github.com/s3ppo/api/commit/8cbb3c47187069155196fbbbdbf507b615a1e125))
* reorder index ([a4b3f8c](https://github.com/s3ppo/api/commit/a4b3f8c6c374d6c7a1c37086f3c7a218cfcf2fb8))
* ReplaceKey functionality in Registration and Update pages ([#1246](https://github.com/s3ppo/api/issues/1246)) ([f3e6a00](https://github.com/s3ppo/api/commit/f3e6a0011ee1bfdd511648105836b94022845ae1))
* send active unraid theme to docs ([#1400](https://github.com/s3ppo/api/issues/1400)) ([f71943b](https://github.com/s3ppo/api/commit/f71943b62b30119e17766e56534962630f52a591))
* simplify docs ([1e4a4f0](https://github.com/s3ppo/api/commit/1e4a4f07451afd347edc4358db2e4c1397976f27))
* slightly better watch mode ([#1398](https://github.com/s3ppo/api/issues/1398)) ([881f1e0](https://github.com/s3ppo/api/commit/881f1e09607d1e4a8606f8d048636ba09d8fcac1))
* split plugin builds ([d63e54b](https://github.com/s3ppo/api/commit/d63e54bdbc7dd47e22dd97075d06d371fe0d73d4))
* swap to absolute paths for css ([#1224](https://github.com/s3ppo/api/issues/1224)) ([dd9983c](https://github.com/s3ppo/api/commit/dd9983c8b7c5a1bbd2a473430b89939627781bd5))
* tailwind v4 ([#1522](https://github.com/s3ppo/api/issues/1522)) ([2c62e0a](https://github.com/s3ppo/api/commit/2c62e0ad09c56d2293b76d07833dfb142c898937))
* trial extension allowed within 5 days of expiration ([#1490](https://github.com/s3ppo/api/issues/1490)) ([f34a33b](https://github.com/s3ppo/api/commit/f34a33bc9f1a7e135d453d9d31888789bfc3f878))
* UnraidCheckExec for Check OS Updates via UPC dropdown ([#1265](https://github.com/s3ppo/api/issues/1265)) ([3a20930](https://github.com/s3ppo/api/commit/3a20930ead41f570198a57fed4f04c1dca239180))
* update packageManager field for pnpm ([eec9785](https://github.com/s3ppo/api/commit/eec9785ba1c8533eb8e3e408b9ced07940abe27e))
* update production release flow to validate less strictly ([#1238](https://github.com/s3ppo/api/issues/1238)) ([bd69b33](https://github.com/s3ppo/api/commit/bd69b3383f7a71a5ca6545c3138f24df9c8e70e4))
* update theme application logic and color picker ([#1181](https://github.com/s3ppo/api/issues/1181)) ([a030626](https://github.com/s3ppo/api/commit/a0306269c61b2600ff57ec3478a646e895d37a54))
* upgrade nuxt-custom-elements ([#1461](https://github.com/s3ppo/api/issues/1461)) ([345e83b](https://github.com/s3ppo/api/commit/345e83bfb0904381d784fc77b3dcd3ad7e53d898))
* upgrade workflow and auto-assign reviewers ([59e48ad](https://github.com/s3ppo/api/commit/59e48ad85c7e1d6127c667407193b4f8546e0b91))
* use bigint instead of long ([#1403](https://github.com/s3ppo/api/issues/1403)) ([574d572](https://github.com/s3ppo/api/commit/574d572d6567c652057b29776694e86267316ca7))
* use patch version if needed on update check ([#1227](https://github.com/s3ppo/api/issues/1227)) ([12e16a6](https://github.com/s3ppo/api/commit/12e16a64047ffb7093b19929255900ea217d2b51))
* **web:** improve notification count syncing ([#1148](https://github.com/s3ppo/api/issues/1148)) ([7588e0e](https://github.com/s3ppo/api/commit/7588e0e3cf8f97c70fe5e0f6fd6aad8a103a9126))
* **web:** install and configure nuxt ui ([#1524](https://github.com/s3ppo/api/issues/1524)) ([407585c](https://github.com/s3ppo/api/commit/407585cd40c409175d8e7b861f8d61d8cabc11c9))
* work intent ([c519ba2](https://github.com/s3ppo/api/commit/c519ba28e49e8de1f0178db56d9a89dcd3ce7c4b))
* work intent process ([8374af8](https://github.com/s3ppo/api/commit/8374af8ee882144e3901619d6f50868a82a0c1b6))


### Bug Fixes

* .env.production from allowing console logs on build ([#1273](https://github.com/s3ppo/api/issues/1273)) ([49f6365](https://github.com/s3ppo/api/commit/49f636541bb579e53b91054ec3a4bef5069abcfa))
* 400 error when submitting connect settings ([831050f](https://github.com/s3ppo/api/commit/831050f4e8c3af4cbcc123a3a609025f250f0824))
* activation indicator removed ([5edfd82](https://github.com/s3ppo/api/commit/5edfd823b862cfc1f864565021f12334fe9317c6))
* add INELIGIBLE state to ConfigErrorState enum ([#1220](https://github.com/s3ppo/api/issues/1220)) ([0f550f9](https://github.com/s3ppo/api/commit/0f550f9d9485c21f4385661c88e367d0a1897382))
* add missing breakpoints ([#1535](https://github.com/s3ppo/api/issues/1535)) ([f5352e3](https://github.com/s3ppo/api/commit/f5352e3a26a2766e85d19ffb5f74960c536b91b3))
* additional url fixes ([4b2763c](https://github.com/s3ppo/api/commit/4b2763c7f9d8b85d5b0ce066dfc9a9a80a115658))
* alignment of settings on ManagementAccess settings page ([#1421](https://github.com/s3ppo/api/issues/1421)) ([70c790f](https://github.com/s3ppo/api/commit/70c790ff89075a785d7f0623bbf3c34a3806bbdc))
* allow rclone to fail to initialize ([#1453](https://github.com/s3ppo/api/issues/1453)) ([7c6f02a](https://github.com/s3ppo/api/commit/7c6f02a5cb474fb285db294ec6f80d1c2c57e142))
* always download 7.1 versioned files for patching ([edc0d15](https://github.com/s3ppo/api/commit/edc0d1578b89c3b3e56e637de07137e069656fa8))
* api `pnpm type-check` ([#1442](https://github.com/s3ppo/api/issues/1442)) ([3122bdb](https://github.com/s3ppo/api/commit/3122bdb953eec58469fd9cf6f468e75621781040))
* **api:** change log output location for diagnostic compatibility ([#1130](https://github.com/s3ppo/api/issues/1130)) ([9bc8060](https://github.com/s3ppo/api/commit/9bc8060a83351aa81ae78c9a345bd2f9f0f4f65f))
* **api:** connect config `email` validation ([#1454](https://github.com/s3ppo/api/issues/1454)) ([b9a1b9b](https://github.com/s3ppo/api/commit/b9a1b9b08746b6d4cb2128d029a3dab7cdd47677))
* **api:** dynamix notifications dir during development ([#1216](https://github.com/s3ppo/api/issues/1216)) ([2700722](https://github.com/s3ppo/api/commit/270072266acdf2dc12a734cdfb643fdf1f3bb988))
* **api:** improve defaults in PM2 service ([#1116](https://github.com/s3ppo/api/issues/1116)) ([a21f39d](https://github.com/s3ppo/api/commit/a21f39d6174e9ffbec31dc7e4f626a4860474d8a))
* **api:** logrotate modification & permissions ([#1145](https://github.com/s3ppo/api/issues/1145)) ([b970fd9](https://github.com/s3ppo/api/commit/b970fd9e6cf40e652934b6c0275b364dab734c47))
* **api:** redirect benign pnpm postinstall warning to log file ([#1290](https://github.com/s3ppo/api/issues/1290)) ([7fb7849](https://github.com/s3ppo/api/commit/7fb78494cb23630f60a889e6252fc06754e14ef9))
* **api:** type imports from generated graphql types ([#1215](https://github.com/s3ppo/api/issues/1215)) ([bce06cd](https://github.com/s3ppo/api/commit/bce06cd76c0f3d00304d1f671621c4862a7311d9))
* backport `<unraid-modals>` upon plg install when necessary ([#1499](https://github.com/s3ppo/api/issues/1499)) ([33e0b1a](https://github.com/s3ppo/api/commit/33e0b1ab24bedb6a2c7b376ea73dbe65bc3044be))
* backport unraid/webgui[#2269](https://github.com/s3ppo/api/issues/2269) rc.nginx update ([#1436](https://github.com/s3ppo/api/issues/1436)) ([a7ef06e](https://github.com/s3ppo/api/commit/a7ef06ea252545cef084e21cea741a8ec866e7cc))
* bigint ([e54d27a](https://github.com/s3ppo/api/commit/e54d27aede1b1e784971468777c5e65cde66f2ac))
* border color incorrect in tailwind ([#1544](https://github.com/s3ppo/api/issues/1544)) ([f14b74a](https://github.com/s3ppo/api/commit/f14b74af91783b08640c0949c51ba7f18508f06f))
* build ([ed67af9](https://github.com/s3ppo/api/commit/ed67af956802eec95845519997bc15b32c84c6ee))
* build issue ([99d8b31](https://github.com/s3ppo/api/commit/99d8b31fa8bef13ae6c7dcf74593bc2999a676ed))
* change config file loading error log to debug ([#1565](https://github.com/s3ppo/api/issues/1565)) ([3534d6f](https://github.com/s3ppo/api/commit/3534d6fdd7c59e65615167cfe306deebad9ca4d3))
* chown correctly ([#1185](https://github.com/s3ppo/api/issues/1185)) ([46a05eb](https://github.com/s3ppo/api/commit/46a05eb76dae3c466a3ea4bd2fd98e8511bc8f9e))
* cleanup build pipeline ([#1326](https://github.com/s3ppo/api/issues/1326)) ([60f16bd](https://github.com/s3ppo/api/commit/60f16bde416993771fce2ad5861a671504af4b7d))
* config migration from `myservers.cfg` ([#1440](https://github.com/s3ppo/api/issues/1440)) ([c4c9984](https://github.com/s3ppo/api/commit/c4c99843c7104414120bffc5dd5ed78ab6c8ba02))
* connect breaks default css of header ([#1155](https://github.com/s3ppo/api/issues/1155)) ([fb24723](https://github.com/s3ppo/api/commit/fb2472399a822a20852841cb5e44d312d2221d17))
* **connect:** fatal race-condition in websocket disposal ([#1462](https://github.com/s3ppo/api/issues/1462)) ([0ec0de9](https://github.com/s3ppo/api/commit/0ec0de982f017b61a145c7a4176718b484834f41))
* **connect:** mothership connection ([#1464](https://github.com/s3ppo/api/issues/1464)) ([7be8bc8](https://github.com/s3ppo/api/commit/7be8bc84d3831f9cea7ff62d0964612ad366a976))
* **connect:** omit extraneous fields during connect config validation ([#1538](https://github.com/s3ppo/api/issues/1538)) ([45bd736](https://github.com/s3ppo/api/commit/45bd73698b2bd534a8aff2c6ac73403de6c58561))
* **connect:** remove unraid-api folder before creating symlink ([#1556](https://github.com/s3ppo/api/issues/1556)) ([514a0ef](https://github.com/s3ppo/api/commit/514a0ef560a90595f774b6c0db60f1d2b4cd853c))
* **connect:** rm eager restart on `ERROR_RETYING` connection status ([#1502](https://github.com/s3ppo/api/issues/1502)) ([dd759d9](https://github.com/s3ppo/api/commit/dd759d9f0f841b296f8083bc67c6cd3f7a69aa5b))
* console hidden ([9b85e00](https://github.com/s3ppo/api/commit/9b85e009b833706294a841a54498e45a8e0204ed))
* container names always null ([#1335](https://github.com/s3ppo/api/issues/1335)) ([8a5b238](https://github.com/s3ppo/api/commit/8a5b23856c006827229812e558f7d1af92be80e0))
* copy dynamix.unraid.net ([662d5f6](https://github.com/s3ppo/api/commit/662d5f64c94586e35bfdaae2df0716c3754b2c45))
* create PR ignored ([dabe334](https://github.com/s3ppo/api/commit/dabe3340721155223fa0d906c6d798faa3b343a3))
* create releases as drafts ([5483e9f](https://github.com/s3ppo/api/commit/5483e9fee99cb1202f2143194d72b02a4c321f37))
* debounce is too long ([#1426](https://github.com/s3ppo/api/issues/1426)) ([f12d231](https://github.com/s3ppo/api/commit/f12d231e6376d0f253cee67b7ed690c432c63ec5))
* DefaultPageLayout patch rollback omits legacy header logo ([#1497](https://github.com/s3ppo/api/issues/1497)) ([ea20d1e](https://github.com/s3ppo/api/commit/ea20d1e2116fcafa154090fee78b42ec5d9ba584))
* delay `nginx:reload` file mod effect by 10 seconds ([#1512](https://github.com/s3ppo/api/issues/1512)) ([af33e99](https://github.com/s3ppo/api/commit/af33e999a0480a77e3e6b2aa833b17b38b835656))
* delete legacy connect keys and ensure description ([22fe91c](https://github.com/s3ppo/api/commit/22fe91cd561e88aa24e8f8cfa5a6143e7644e4e0))
* **deps:** pin dependencies ([#1465](https://github.com/s3ppo/api/issues/1465)) ([ba75a40](https://github.com/s3ppo/api/commit/ba75a409a4d3e820308b78fd5a5380021d3757b0))
* **deps:** pin dependencies ([#1470](https://github.com/s3ppo/api/issues/1470)) ([412b329](https://github.com/s3ppo/api/commit/412b32996d9c8352c25309cc0d549a57468d0fb5))
* **deps:** pin dependencies ([#1528](https://github.com/s3ppo/api/issues/1528)) ([a74d935](https://github.com/s3ppo/api/commit/a74d935b566dd7af1a21824c9b7ab562232f9d8b))
* **deps:** pin dependencies ([#1586](https://github.com/s3ppo/api/issues/1586)) ([5721785](https://github.com/s3ppo/api/commit/57217852a337ead4c8c8e7596d1b7d590b64a26f))
* **deps:** pin dependency @nuxt/ui to 3.2.0 ([#1532](https://github.com/s3ppo/api/issues/1532)) ([8279531](https://github.com/s3ppo/api/commit/8279531f2b86a78e81a77e6c037a0fb752e98062))
* **deps:** storybook v9 ([#1476](https://github.com/s3ppo/api/issues/1476)) ([45bb49b](https://github.com/s3ppo/api/commit/45bb49bcd60a9753be492203111e489fd37c1a5f))
* **deps:** update all non-major dependencies ([#1158](https://github.com/s3ppo/api/issues/1158)) ([48df88f](https://github.com/s3ppo/api/commit/48df88f5c1c1bb72cbb06d0697d233532466127b))
* **deps:** update all non-major dependencies ([#1168](https://github.com/s3ppo/api/issues/1168)) ([248d211](https://github.com/s3ppo/api/commit/248d21105086362fe56826870a91f459476d3d9b))
* **deps:** update all non-major dependencies ([#1192](https://github.com/s3ppo/api/issues/1192)) ([b5f3a37](https://github.com/s3ppo/api/commit/b5f3a3786305d21edc8a0cb436d34406c2f497fc))
* **deps:** update all non-major dependencies ([#1236](https://github.com/s3ppo/api/issues/1236)) ([9d63e56](https://github.com/s3ppo/api/commit/9d63e563741f9940b7ae9473c85a7312dea6d917))
* **deps:** update all non-major dependencies ([#1247](https://github.com/s3ppo/api/issues/1247)) ([57a6c49](https://github.com/s3ppo/api/commit/57a6c49f8a77239e5b97b29d091d9744e8d06fb0))
* **deps:** update all non-major dependencies ([#1251](https://github.com/s3ppo/api/issues/1251)) ([ad3906e](https://github.com/s3ppo/api/commit/ad3906e68200571efe98d2f486f4d8ae7e02508e))
* **deps:** update all non-major dependencies ([#1253](https://github.com/s3ppo/api/issues/1253)) ([bbb02e9](https://github.com/s3ppo/api/commit/bbb02e991c787ca06d42add053dfed6b4fdd810c))
* **deps:** update all non-major dependencies ([#1337](https://github.com/s3ppo/api/issues/1337)) ([2345732](https://github.com/s3ppo/api/commit/234573264cfed1409a767927ff95f132be393ea9))
* **deps:** update all non-major dependencies ([#1366](https://github.com/s3ppo/api/issues/1366)) ([291ee47](https://github.com/s3ppo/api/commit/291ee475fb9ef44f6da7b76a9eb11b7dd29a5d13))
* **deps:** update all non-major dependencies ([#1379](https://github.com/s3ppo/api/issues/1379)) ([8f70326](https://github.com/s3ppo/api/commit/8f70326d0fe3e4c3bcd3e8e4e6566766f1c05eb7))
* **deps:** update all non-major dependencies ([#1389](https://github.com/s3ppo/api/issues/1389)) ([cb43f95](https://github.com/s3ppo/api/commit/cb43f95233590888a8e20a130e62cadc176c6793))
* **deps:** update all non-major dependencies ([#1399](https://github.com/s3ppo/api/issues/1399)) ([68df344](https://github.com/s3ppo/api/commit/68df344a4b412227cffa96867f086177b251f028))
* **deps:** update all non-major dependencies ([#1489](https://github.com/s3ppo/api/issues/1489)) ([53b05eb](https://github.com/s3ppo/api/commit/53b05ebe5e2050cb0916fcd65e8d41370aee0624))
* **deps:** update all non-major dependencies ([#1510](https://github.com/s3ppo/api/issues/1510)) ([1a8da6d](https://github.com/s3ppo/api/commit/1a8da6d92b96d3afa2a8b42446b36f1ee98b64a0))
* **deps:** update all non-major dependencies ([#1520](https://github.com/s3ppo/api/issues/1520)) ([e2fa648](https://github.com/s3ppo/api/commit/e2fa648d1cf5a6cbe3e55c3f52c203d26bb4d526))
* **deps:** update all non-major dependencies ([#1543](https://github.com/s3ppo/api/issues/1543)) ([18b5209](https://github.com/s3ppo/api/commit/18b52090874c0ba86878d0f7e31bf0dc42734d75))
* **deps:** update all non-major dependencies ([#1579](https://github.com/s3ppo/api/issues/1579)) ([ad6aa3b](https://github.com/s3ppo/api/commit/ad6aa3b6743aeeb42eff34d1c89ad874dfd0af09))
* **deps:** update dependency @apollo/client to v3.12.9 ([5b14be6](https://github.com/s3ppo/api/commit/5b14be6b0f1e896bb721216c29deeade6eb4592a))
* **deps:** update dependency @nestjs/passport to v11 ([#1244](https://github.com/s3ppo/api/issues/1244)) ([9e54237](https://github.com/s3ppo/api/commit/9e54237670bdd1c835455c18e6f1f88f1824db77))
* **deps:** update dependency @nestjs/schedule to v5 ([#1197](https://github.com/s3ppo/api/issues/1197)) ([85c8ef5](https://github.com/s3ppo/api/commit/85c8ef53add3c21817225072bbfed880f1ddf128))
* **deps:** update dependency @types/diff to v8 ([#1393](https://github.com/s3ppo/api/issues/1393)) ([00da27d](https://github.com/s3ppo/api/commit/00da27d04f2ee2ca8b8b9cdcc6ea3c490c02a3a4))
* **deps:** update dependency @vueuse/core to v12 ([#1199](https://github.com/s3ppo/api/issues/1199)) ([ff8eba3](https://github.com/s3ppo/api/commit/ff8eba3df542d11bc37897ec1b6246ad89d5fa19))
* **deps:** update dependency cache-manager to v7 ([#1413](https://github.com/s3ppo/api/issues/1413)) ([9492c2a](https://github.com/s3ppo/api/commit/9492c2ae6a0086d14e73d280c55746206b73a7b0))
* **deps:** update dependency chalk to v5 ([#1296](https://github.com/s3ppo/api/issues/1296)) ([6bed638](https://github.com/s3ppo/api/commit/6bed63805ff026be98a8e20c4d8a37cd47048357))
* **deps:** update dependency commander to v14 ([#1394](https://github.com/s3ppo/api/issues/1394)) ([106ea09](https://github.com/s3ppo/api/commit/106ea093996f2d0c71c1511bc009ecc9a6be91ec))
* **deps:** update dependency diff to v7 ([#1297](https://github.com/s3ppo/api/issues/1297)) ([3c6683c](https://github.com/s3ppo/api/commit/3c6683c81422a088c13e9545aaecececd78b8628))
* **deps:** update dependency diff to v8 ([#1386](https://github.com/s3ppo/api/issues/1386)) ([e580f64](https://github.com/s3ppo/api/commit/e580f646a52b8bda605132cf44ec58137e08dd42))
* **deps:** update dependency dockerode to v4 ([#830](https://github.com/s3ppo/api/issues/830)) ([c311a89](https://github.com/s3ppo/api/commit/c311a89aee450b033aa33795730217f8e53880fd))
* **deps:** update dependency dotenv to v17 ([#1474](https://github.com/s3ppo/api/issues/1474)) ([d613bfa](https://github.com/s3ppo/api/commit/d613bfa0410e7ef8451fc8ea20e57a7db67f7994))
* **deps:** update dependency graphql-subscriptions to v3 ([#1209](https://github.com/s3ppo/api/issues/1209)) ([c9789ac](https://github.com/s3ppo/api/commit/c9789ac1f2a878b930a3e58f15bedf75d531a674))
* **deps:** update dependency ini to v5 ([#1217](https://github.com/s3ppo/api/issues/1217)) ([590ab73](https://github.com/s3ppo/api/commit/590ab7327f1399d6c558a9c65fab8f1a79238c4b))
* **deps:** update dependency jose to v6 ([#1248](https://github.com/s3ppo/api/issues/1248)) ([03ece33](https://github.com/s3ppo/api/commit/03ece335b82caf2d1146bebd2fa41f25de827f24))
* **deps:** update dependency lucide-vue-next to ^0.509.0 ([#1383](https://github.com/s3ppo/api/issues/1383)) ([469333a](https://github.com/s3ppo/api/commit/469333acd4a0cbeecc9e9cbadb2884289d83aee3))
* **deps:** update dependency marked to v15 ([#1249](https://github.com/s3ppo/api/issues/1249)) ([8f78b3f](https://github.com/s3ppo/api/commit/8f78b3f1cac4c6e396f923cfa7e7320849bfa265))
* **deps:** update dependency marked to v16 ([#1444](https://github.com/s3ppo/api/issues/1444)) ([453a5b2](https://github.com/s3ppo/api/commit/453a5b2c9591f755ce07548a9996d7a6cf0925c4))
* **deps:** update dependency pino-pretty to v13 ([#1250](https://github.com/s3ppo/api/issues/1250)) ([1892e23](https://github.com/s3ppo/api/commit/1892e23c22d8d05043113b047794af0601db392f))
* **deps:** update dependency pm2 to v6 ([#1258](https://github.com/s3ppo/api/issues/1258)) ([d8afc8f](https://github.com/s3ppo/api/commit/d8afc8f4c9de84833a6f4cd6fed887426db5590e))
* **deps:** update dependency shadcn-vue to v1 ([#1259](https://github.com/s3ppo/api/issues/1259)) ([cb2020d](https://github.com/s3ppo/api/commit/cb2020dee69a09c9408a54b1de9f4eb81e6f9234))
* **deps:** update dependency shadcn-vue to v2 ([#1302](https://github.com/s3ppo/api/issues/1302)) ([26ecf77](https://github.com/s3ppo/api/commit/26ecf779e675d0bc533d61e045325ab062effcbf))
* **deps:** update dependency vue-i18n to v11 ([#1261](https://github.com/s3ppo/api/issues/1261)) ([2c01ba9](https://github.com/s3ppo/api/commit/2c01ba9610eb759e255518da553741b08ac0ce39))
* **deps:** update dependency vue-sonner to v2 ([#1401](https://github.com/s3ppo/api/issues/1401)) ([53ca414](https://github.com/s3ppo/api/commit/53ca41404f13c057c340dcf9010af72c3365e499))
* **deps:** update graphqlcodegenerator monorepo ([2bc9af2](https://github.com/s3ppo/api/commit/2bc9af25783aa969a4fa8d770ca9884e67631eef))
* **deps:** update vueuse monorepo to v13 (major) ([#1262](https://github.com/s3ppo/api/issues/1262)) ([9ce10a7](https://github.com/s3ppo/api/commit/9ce10a72b2dc9fcc278bd48a99cb6c809fcae7a9))
* disable all config watchers ([#1306](https://github.com/s3ppo/api/issues/1306)) ([5c1b435](https://github.com/s3ppo/api/commit/5c1b4352cf71d8525f667822f8ca202e2934f463))
* disable file changes on Unraid 7.2 ([#1382](https://github.com/s3ppo/api/issues/1382)) ([02de89d](https://github.com/s3ppo/api/commit/02de89d1309f67e4b6d4f8de5f66815ee4d2464c))
* do not process.exit on restart or stop command ([e16763b](https://github.com/s3ppo/api/commit/e16763b49bb5a61f1a86f0531cfdb87cd5c7d927))
* do not start API with doinst.sh ([7d88b33](https://github.com/s3ppo/api/commit/7d88b3393cbd8ab1e93a86dfa1b7b74cc97255cc))
* do not uninstall fully on 7.2 ([#1484](https://github.com/s3ppo/api/issues/1484)) ([2263881](https://github.com/s3ppo/api/commit/22638811a9fdb524420b1347ac49cfaa51bbecb5))
* docs creation workflow ([13b501a](https://github.com/s3ppo/api/commit/13b501a342186ed322c0cef095eec33bb1bc065d))
* don't mv deploy on prod release ([9568aab](https://github.com/s3ppo/api/commit/9568aabd17fbab9e7e2f06f723ee57dc2026583c))
* don't specify pnpm version in install ([30ba5be](https://github.com/s3ppo/api/commit/30ba5befdbc5fa33122f26284e80584ae60513ec))
* drop console with terser ([a87d455](https://github.com/s3ppo/api/commit/a87d455bace04aab9d7fa0e63cb61d26ef9b3b72))
* duplicated header logo after api stops ([#1493](https://github.com/s3ppo/api/issues/1493)) ([4168f43](https://github.com/s3ppo/api/commit/4168f43e3ecd51479bec3aae585abbe6dcd3e416))
* empty manifest and version alignment ([b07828d](https://github.com/s3ppo/api/commit/b07828d6554240acec180b993df3a75407126c6a))
* enhance plugin management with interactive removal prompts ([#1549](https://github.com/s3ppo/api/issues/1549)) ([23ef760](https://github.com/s3ppo/api/commit/23ef760d763c525a38108048200fa73fc8531aed))
* ensure no crash if emhttp state configs are missing ([#1514](https://github.com/s3ppo/api/issues/1514)) ([1a7d35d](https://github.com/s3ppo/api/commit/1a7d35d3f6972fd8aff58c17b2b0fb79725e660e))
* error logs from `cloud` query when connect is not installed ([#1450](https://github.com/s3ppo/api/issues/1450)) ([719f460](https://github.com/s3ppo/api/commit/719f460016d769255582742d7d71ca97d132022b))
* event emitter setup for writing status ([#1496](https://github.com/s3ppo/api/issues/1496)) ([ca4e2db](https://github.com/s3ppo/api/commit/ca4e2db1f29126a1fa3784af563832edda64b0ca))
* extract callbacks to library ([#1280](https://github.com/s3ppo/api/issues/1280)) ([2266139](https://github.com/s3ppo/api/commit/226613974258f15d39932de94316a54aec2e29d2))
* finalize workflow fixes ([616be93](https://github.com/s3ppo/api/commit/616be93be92084fbb432e3d164a64b32906caaf0))
* fix changelog thing again ([a9d5ca8](https://github.com/s3ppo/api/commit/a9d5ca88996129b8d452ccfbf308471cc0edbd04))
* fix invalid path to node with sh execution ([#1213](https://github.com/s3ppo/api/issues/1213)) ([f1838bf](https://github.com/s3ppo/api/commit/f1838bf69a55453eee3c23816c10bec0acc943c5))
* fix libvirt bindings ([#1167](https://github.com/s3ppo/api/issues/1167)) ([024719f](https://github.com/s3ppo/api/commit/024719fa7a24c5b9f46936cce037b89a1dd50b62))
* flash backup integration with Unraid Connect config ([#1448](https://github.com/s3ppo/api/issues/1448)) ([038c582](https://github.com/s3ppo/api/commit/038c582aed5f5efaea3583372778b9baa318e1ea))
* header padding regression ([#1477](https://github.com/s3ppo/api/issues/1477)) ([e791cc6](https://github.com/s3ppo/api/commit/e791cc680de9c40378043348ddca70902da6d250))
* **HeaderOsVersion:** adjust top margin for header component ([#1485](https://github.com/s3ppo/api/issues/1485)) ([862b54d](https://github.com/s3ppo/api/commit/862b54de8cd793606f1d29e76c19d4a0e1ae172f))
* hide reboot notice for patch releases ([#1341](https://github.com/s3ppo/api/issues/1341)) ([4b57439](https://github.com/s3ppo/api/commit/4b5743906a172f84bb46011fe2c3e0c8f64059a2))
* incorrect state merging in redux store ([#1437](https://github.com/s3ppo/api/issues/1437)) ([17b7428](https://github.com/s3ppo/api/commit/17b74287796e6feb75466033e279dc3bcf57f1e6))
* inject Tailwind CSS into client entry point ([#1537](https://github.com/s3ppo/api/issues/1537)) ([86b6c4f](https://github.com/s3ppo/api/commit/86b6c4f85b7b30bb4a13d57450a76bf4c28a3fff))
* insecure routes not working for SSO ([#1587](https://github.com/s3ppo/api/issues/1587)) ([a4ff3c4](https://github.com/s3ppo/api/commit/a4ff3c40926915f6989ed4af679b30cf295ea15d))
* install as-integrations/fastify ([2fce2e9](https://github.com/s3ppo/api/commit/2fce2e9a28fc633d4e452399673b1a35e785ba8f))
* invalid configs no longer crash API ([#1491](https://github.com/s3ppo/api/issues/1491)) ([6bf3f77](https://github.com/s3ppo/api/commit/6bf3f776380edeff5133517e6aca223556e30144))
* invalid state for unraid plugin ([#1492](https://github.com/s3ppo/api/issues/1492)) ([39b8f45](https://github.com/s3ppo/api/commit/39b8f453da23793ef51f8e7f7196370aada8c5aa))
* issue with invalid builds for prod and tagging ([7e89cd2](https://github.com/s3ppo/api/commit/7e89cd2a3e06a4abc8164f2f4985ad9f6cc9388d))
* lanip copy button not present ([#1459](https://github.com/s3ppo/api/issues/1459)) ([a280786](https://github.com/s3ppo/api/commit/a2807864acef742e454d87bb093ee91806e527e5))
* lint ([133c8e0](https://github.com/s3ppo/api/commit/133c8e0d704a6f2cc6e57e7b1c06221d09ad6c8b))
* load tag correctly ([b24a575](https://github.com/s3ppo/api/commit/b24a575cbbb972c843b5c9dd36726dab4f8ca2b5))
* log errors ([365dcae](https://github.com/s3ppo/api/commit/365dcae04babae688dcc49ee17efbf34288d35a8))
* main.yml release issue ([2b1e307](https://github.com/s3ppo/api/commit/2b1e3076b005106d8bbf7efd624a9ee18dce6eda))
* make backup of txz ([37e72f9](https://github.com/s3ppo/api/commit/37e72f9729f6ab385ed1070fbdca6028688fbd92))
* make public not a part of folder structure in PR ([84611d7](https://github.com/s3ppo/api/commit/84611d769189ee33acb04188ece08a1c84f911d1))
* make scripts executable when building the plugin ([#1255](https://github.com/s3ppo/api/issues/1255)) ([7bc9949](https://github.com/s3ppo/api/commit/7bc9949110b29d36209e48414f40bd2379cab852))
* make settings grid responsive ([#1463](https://github.com/s3ppo/api/issues/1463)) ([9dfdb8d](https://github.com/s3ppo/api/commit/9dfdb8dce781fa662d6434ee432e4521f905ffa5))
* move docker mutations to the mutations resolver ([#1333](https://github.com/s3ppo/api/issues/1333)) ([1bbe7d2](https://github.com/s3ppo/api/commit/1bbe7d27b0e87b5ffcd57ac9cc28e64b046055be))
* move to bigint scalar ([b625227](https://github.com/s3ppo/api/commit/b625227913e80e4731a13b54b525ec7385918c51))
* **my.servers:** improve DNS resolution robustness for backup server ([#1518](https://github.com/s3ppo/api/issues/1518)) ([eecd9b1](https://github.com/s3ppo/api/commit/eecd9b1017a63651d1dc782feaa224111cdee8b6))
* node installation not persisting across reboots ([#1256](https://github.com/s3ppo/api/issues/1256)) ([3bfcc8e](https://github.com/s3ppo/api/commit/3bfcc8e8c0480df3f6452efea752461bf52cdc4b))
* node_modules dir removed on plugin update ([#1406](https://github.com/s3ppo/api/issues/1406)) ([7b005cb](https://github.com/s3ppo/api/commit/7b005cbbf682a1336641f5fc85022e9d651569d0))
* **notifications:** gracefully handle & mask invalid notifications ([#1529](https://github.com/s3ppo/api/issues/1529)) ([05056e7](https://github.com/s3ppo/api/commit/05056e7ca1702eb7bf6c507950460b6b15bf7916))
* OEM plugin issues ([#1288](https://github.com/s3ppo/api/issues/1288)) ([d5a3d0d](https://github.com/s3ppo/api/commit/d5a3d0dfac214fc433c2c0aec578de564a990dd4))
* omit Connect actions in UPC when plugin is not installed ([#1417](https://github.com/s3ppo/api/issues/1417)) ([8c8a527](https://github.com/s3ppo/api/commit/8c8a5276b49833c08bca133e374e1e66273b41aa))
* one-command dev & web env files ([#1214](https://github.com/s3ppo/api/issues/1214)) ([4641894](https://github.com/s3ppo/api/commit/4641894240601c91d64fea0831cf08fcf73b87ef))
* only run release if releases_create == 'true' ([00a444f](https://github.com/s3ppo/api/commit/00a444fb92725362946673ac4d9873ac8f438602))
* ordering in build script ([a562f77](https://github.com/s3ppo/api/commit/a562f7716380bde4a1ae0d6960eff51c37b9291c))
* over-eager cloud query from web components ([#1506](https://github.com/s3ppo/api/issues/1506)) ([074370c](https://github.com/s3ppo/api/commit/074370c42cdecc4dbc58193ff518aa25735c56b3))
* parsing of `ssoEnabled` in state.php ([#1455](https://github.com/s3ppo/api/issues/1455)) ([f542c8e](https://github.com/s3ppo/api/commit/f542c8e0bd9596d9d3abf75b58b97d95fb033215))
* patch version override logic incorrect ([#1275](https://github.com/s3ppo/api/issues/1275)) ([0bcfb47](https://github.com/s3ppo/api/commit/0bcfb47bbcdfa05b706ee2d98ebb9083762215ef))
* PHP Warning in state.php ([#1126](https://github.com/s3ppo/api/issues/1126)) ([59d6c1b](https://github.com/s3ppo/api/commit/59d6c1b678b70e678be5e50e1cde3f25f2758006))
* pin ranges ([#1460](https://github.com/s3ppo/api/issues/1460)) ([f88400e](https://github.com/s3ppo/api/commit/f88400eea820ac80c867fdb63cd503ed91493146))
* **plugin:** flaky masking of benign warning during pnpm install ([#1313](https://github.com/s3ppo/api/issues/1313)) ([1f10b63](https://github.com/s3ppo/api/commit/1f10b63c8b015e9a2527f79e15a7042feb2d2aca))
* PR build issue ([457d338](https://github.com/s3ppo/api/commit/457d338150774ddc14cde6562e226a6a565aca48))
* pr plugin promotion workflow ([#1456](https://github.com/s3ppo/api/issues/1456)) ([13bd9bb](https://github.com/s3ppo/api/commit/13bd9bb5670bb96b158068114d62572d88c7cae9))
* proper fallback if missing paths config modules ([7067e9e](https://github.com/s3ppo/api/commit/7067e9e3dd3966309013b52c90090cc82de4e4fb))
* rc.unraid-api now cleans up older dependencies ([#1404](https://github.com/s3ppo/api/issues/1404)) ([83076bb](https://github.com/s3ppo/api/commit/83076bb94088095de8b1a332a50bbef91421f0c1))
* re-add manifest ([e721299](https://github.com/s3ppo/api/commit/e72129953ebf5f5f628406678adb6daf04aaf2c8))
* re-release fixed ([b491590](https://github.com/s3ppo/api/commit/b49159022d982ff989194c06a74ceac370a69bc7))
* recreate watcher on path change ([#1203](https://github.com/s3ppo/api/issues/1203)) ([bde37d6](https://github.com/s3ppo/api/commit/bde37d67517306fcab9f77fc243465673d35135a))
* refactor API client to support Unix socket connections ([#1575](https://github.com/s3ppo/api/issues/1575)) ([a2c5d24](https://github.com/s3ppo/api/commit/a2c5d2495ffc02efa1ec5c63f0a1c5d23c9ed7ff))
* release note escaping ([5b6bcb6](https://github.com/s3ppo/api/commit/5b6bcb6043a5269bff4dc28714d787a5a3f07e22))
* release-please upload single draft ([db134f0](https://github.com/s3ppo/api/commit/db134f091d8b8398c02e25f1d97dd0015fad6377))
* remote access lifecycle during boot & shutdown ([#1422](https://github.com/s3ppo/api/issues/1422)) ([7bc583b](https://github.com/s3ppo/api/commit/7bc583b18621c8140232772ca36c6d9b8d8a9cd7))
* remove connect api plugin upon removal of Connect Unraid plugin ([#1548](https://github.com/s3ppo/api/issues/1548)) ([782d5eb](https://github.com/s3ppo/api/commit/782d5ebadc67854298f3b2355255983024d2a225))
* remove devDependencies from output package json ([d847815](https://github.com/s3ppo/api/commit/d8478152e913fab2974a18eed69c4eb01f7fde27))
* remove some unused fields from the report object ([#1342](https://github.com/s3ppo/api/issues/1342)) ([cd323ac](https://github.com/s3ppo/api/commit/cd323acd4905a558786b029ff5a30371c4512956))
* remove unneeded workflow secret pass ([4bb00dd](https://github.com/s3ppo/api/commit/4bb00dd981384083cec40d804209ec2ca18d7aae))
* replace files lost during pruning ([d0d2ff6](https://github.com/s3ppo/api/commit/d0d2ff65ed2d51223414e50bb1c2ecf82e32a071))
* replace myservers.cfg reads in UpdateFlashBackup.php ([#1517](https://github.com/s3ppo/api/issues/1517)) ([441e180](https://github.com/s3ppo/api/commit/441e1805c108a6c1cd35ee093246b975a03f8474))
* revert changelog ([efa7db3](https://github.com/s3ppo/api/commit/efa7db3db6d150d4a5b142ae2c522728f7621afb))
* revert config ([7957c2a](https://github.com/s3ppo/api/commit/7957c2a681c82b2a6b0b8024fbf1e9383ea676ad))
* revert dockerode upgrade ([#1140](https://github.com/s3ppo/api/issues/1140)) ([2b163b3](https://github.com/s3ppo/api/commit/2b163b361a1bcdae36b67798e4b4c7856eba2cac))
* rm short-circuit in `rc.unraid-api` if plugin config dir is absent ([#1515](https://github.com/s3ppo/api/issues/1515)) ([29dcb7d](https://github.com/s3ppo/api/commit/29dcb7d0f088937cefc5158055f48680e86e5c36))
* shorten work intent form ([5b2403a](https://github.com/s3ppo/api/commit/5b2403ad0418aa75dee1d436e84eb1f7ce463099))
* sign out correctly on error ([#1452](https://github.com/s3ppo/api/issues/1452)) ([d08fc94](https://github.com/s3ppo/api/commit/d08fc94afb94e386907da44402ee5a24cfb3d00a))
* sign out doesn't work ([#1486](https://github.com/s3ppo/api/issues/1486)) ([f3671c3](https://github.com/s3ppo/api/commit/f3671c3e0750b79be1f19655a07a0e9932289b3f))
* simplify api setup index ([5f29e6d](https://github.com/s3ppo/api/commit/5f29e6d5e76136c23e708d4a3604425ad4f90138))
* simplify upcoming features ([608151d](https://github.com/s3ppo/api/commit/608151d84c55f1bdc07c05334cfffaf35cd5b74e))
* simplify usb listing ([#1402](https://github.com/s3ppo/api/issues/1402)) ([5355115](https://github.com/s3ppo/api/commit/5355115af2f4122af9afa3f63ed8f830b33cbf5c))
* small modal window ([#1183](https://github.com/s3ppo/api/issues/1183)) ([08423b8](https://github.com/s3ppo/api/commit/08423b8dae91ed135815b69df6733cefd96b9c33))
* SSO not being detected ([#1546](https://github.com/s3ppo/api/issues/1546)) ([6b3b951](https://github.com/s3ppo/api/commit/6b3b951d8288cd31d096252be544537dc2bfce50))
* sso unreliable if API outputs more than raw json ([#1353](https://github.com/s3ppo/api/issues/1353)) ([e65775f](https://github.com/s3ppo/api/commit/e65775f8782714d1cc29c8f2801244b5a4043409))
* staging build issues ([63fcde8](https://github.com/s3ppo/api/commit/63fcde82433756205af0e2d22018d157c7950320))
* stepper fixes ([#1240](https://github.com/s3ppo/api/issues/1240)) ([6c042cb](https://github.com/s3ppo/api/commit/6c042cbe01211e1476d40f5cec42a353585fff92))
* storybook resolution issue ([#1153](https://github.com/s3ppo/api/issues/1153)) ([5a3e8df](https://github.com/s3ppo/api/commit/5a3e8df003a5005acc39442160e263f86793ce88))
* theme issues when sent from graph ([#1424](https://github.com/s3ppo/api/issues/1424)) ([75ad838](https://github.com/s3ppo/api/commit/75ad8381bd4f4045ab1d3aa84e08ecddfba27617))
* **theme:** API key white text on white background ([#1584](https://github.com/s3ppo/api/issues/1584)) ([b321687](https://github.com/s3ppo/api/commit/b3216874faae208cdfc3edec719629fce428b6a3))
* truncate log files when they take up more than 5mb of space ([#1530](https://github.com/s3ppo/api/issues/1530)) ([0a18b38](https://github.com/s3ppo/api/commit/0a18b38008dd86a125cde7f684636d5dbb36f082))
* **ui:** notifications positioning regression ([#1445](https://github.com/s3ppo/api/issues/1445)) ([f73e5e0](https://github.com/s3ppo/api/commit/f73e5e0058fcc3bedebfbe7380ffcb44aea981b8))
* unique artifact ID ([0f682b5](https://github.com/s3ppo/api/commit/0f682b5f23f4319a1ad8f0e8f2b5e5ae0a2293db))
* update brand loading variants for consistent sizing ([#1223](https://github.com/s3ppo/api/issues/1223)) ([1b0fbaf](https://github.com/s3ppo/api/commit/1b0fbaf81a90220ae9e9a8f2834041239999dc02))
* update configValid state to ineligible in var.ini and adjust rel… ([#1268](https://github.com/s3ppo/api/issues/1268)) ([cc85fba](https://github.com/s3ppo/api/commit/cc85fba207ef8429fee5b8fce0fbb886cd9d4eb4))
* update Docusaurus PR workflow to process and copy API docs ([3a10871](https://github.com/s3ppo/api/commit/3a10871918fe392a1974b69d16a135546166e058))
* update OIDC provider setup documentation for navigation clarity ([1a01696](https://github.com/s3ppo/api/commit/1a01696dc7b947abf5f2f097de1b231d5593c2ff))
* update OIDC provider setup documentation for redirect URI and screenshots ([1bc5251](https://github.com/s3ppo/api/commit/1bc52513109436b3ce8237c3796af765e208f9fc))
* Update renovate.json ([c47a655](https://github.com/s3ppo/api/commit/c47a655b45323629ef3f6763ea8a714a62629aa0))
* upload to correct tag directory on build ([f76c0f0](https://github.com/s3ppo/api/commit/f76c0f05fb230a8ac3c84c31b10b52ee2ea14b8a))
* upload to release by name ([2283e06](https://github.com/s3ppo/api/commit/2283e064d5ccd8aac3ee7d1a4c4fa353f50f108f))
* use async for primary file read/writes ([#1531](https://github.com/s3ppo/api/issues/1531)) ([23b2b88](https://github.com/s3ppo/api/commit/23b2b8846158a27d1c9808bce0cc1506779c4dc3))
* use batchProcess ([3c357e7](https://github.com/s3ppo/api/commit/3c357e7e957f550b22eabfb2d27741d84183ebc5))
* use some instead of every for connect detection ([9ce2fee](https://github.com/s3ppo/api/commit/9ce2fee380c4db1395f5d4df7f16ae6c57d1a748))
* vms now can detect starting of libvirt and start local hypervisor ([#1356](https://github.com/s3ppo/api/issues/1356)) ([ad0f4c8](https://github.com/s3ppo/api/commit/ad0f4c8b55c7f7e94fbae2108f17715b1373a3ef))
* **web:** broken modals ([19208e5](https://github.com/s3ppo/api/commit/19208e5fabc91ade802e2dd2ef4d36e4a157af81))
* **web:** name of toaster component ([93980f9](https://github.com/s3ppo/api/commit/93980f929dab66f6eb032173ca65dca857b2eaf5))
* **web:** track 'notification seen' state across tabs & page loads ([#1121](https://github.com/s3ppo/api/issues/1121)) ([321703e](https://github.com/s3ppo/api/commit/321703e907356a8a2f2665464773d856decdbcd7))


### Reverts

* revert package.json dependency updates from commit 711cc9a for api and packages/* ([94420e4](https://github.com/s3ppo/api/commit/94420e4d45735b8def3915b5789c15c1c3121f1e))


### Miscellaneous Chores

* release 4.1.2 ([2323ee6](https://github.com/s3ppo/api/commit/2323ee6838d9459e97bb137b010d87aae52d5d86))
